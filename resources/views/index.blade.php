 ...
 @include('layouts.menu')
  ...
  <div class="header__right">
    <div class="header__right-box">
        ...
        <select name="genre_id" class="header__right-box-select">
  ...
  @foreach($shops as $shop => $data)
    <div class="box" id="box{{ $loop->index }}">
      ...
      <div class="box__card">
        ...
        @endif
        <input type="hidden" name="restrant_id" value="{{ $data->id }}">
        ...
        <div class="box__card-key">
          <span id="box__card-key-name">#{{ $data->area->name }}</span>
          <span id="box__card-key-area">#{{ $data->genre->name }}</span>
        </div>
